...
Step-3 
      Clone the Repository "Dspace-Labs/dspace-dev-docker"
             $ git clone https://github.com/DSpace-Labs/dspace-dev-docker.git
             $ cd dspace-dev-docker
Step-4
      Clone the DSpace Repository in dspace-src folder 
             $ git clone -b dspace-6.0 https://github.com/DSpace/DSpace.git dspace-src

Step-5
      Also, add m2-repo and dspace-build folders.
            $ mkdir m2-repo dspace-build
            
Step-6 (Optional)
      If you already have a working copy of DSpace checked out on your computer:
